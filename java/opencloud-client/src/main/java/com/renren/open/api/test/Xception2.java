...
public class Xception2 extends Exception implements org.apache.thrift.TBase<Xception2, Xception2._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Xception2 other) {
    ...
    Xception2 typedOther = (Xception2)other;
