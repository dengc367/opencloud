...
public class VersioningTestV1 implements org.apache.thrift.TBase<VersioningTestV1, VersioningTestV1._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(VersioningTestV1 other) {
    ...
    VersioningTestV1 typedOther = (VersioningTestV1)other;
    ...
    lastComparison = Boolean.valueOf(isSetOld_string()).compareTo(typedOther.isSetOld_string());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOld_string()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.old_string, typedOther.old_string);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
