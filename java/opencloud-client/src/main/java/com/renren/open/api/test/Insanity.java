...
public class Insanity implements org.apache.thrift.TBase<Insanity, Insanity._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Insanity other) {
    ...
    if (isSetUserMap()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.userMap, typedOther.userMap);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetXtructs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.xtructs, typedOther.xtructs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
