...
public class ListTypeVersioningV1 implements org.apache.thrift.TBase<ListTypeVersioningV1, ListTypeVersioningV1._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(ListTypeVersioningV1 other) {
    ...
    ListTypeVersioningV1 typedOther = (ListTypeVersioningV1)other;

    lastComparison = Boolean.valueOf(isSetMyints()).compareTo(typedOther.isSetMyints());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMyints()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.myints, typedOther.myints);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
