...
public class Xtruct implements org.apache.thrift.TBase<Xtruct, Xtruct._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Xtruct other) {
    ...
    if (isSetString_thing()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.string_thing, typedOther.string_thing);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetByte_thing()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.byte_thing, typedOther.byte_thing);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetI32_thing()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.i32_thing, typedOther.i32_thing);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetI64_thing()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.i64_thing, typedOther.i64_thing);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
