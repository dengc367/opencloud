...
public class ListTypeVersioningV2 implements org.apache.thrift.TBase<ListTypeVersioningV2, ListTypeVersioningV2._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(ListTypeVersioningV2 other) {
    ...
    ListTypeVersioningV2 typedOther = (ListTypeVersioningV2)other;

    lastComparison = Boolean.valueOf(isSetStrings()).compareTo(typedOther.isSetStrings());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStrings()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.strings, typedOther.strings);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
