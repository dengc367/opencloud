...
public class Bools implements org.apache.thrift.TBase<Bools, Bools._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Bools other) {
    ...
    if (isSetIm_true()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.im_true, typedOther.im_true);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetIm_false()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.im_false, typedOther.im_false);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
