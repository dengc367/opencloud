...
public class VersioningTestV2 implements org.apache.thrift.TBase<VersioningTestV2, VersioningTestV2._Fields>, java.io.Serializable, Cloneable {
  ...
  public VersioningTestV2(VersioningTestV2 other) {
    ...
    if (other.isSetNewmap()) {
      Map<Integer,Integer> __this__newmap = new HashMap<Integer,Integer>();
  ...
  public void unsetBegin_in_both() {
    __isset_bit_vector.clear(__BEGIN_IN_BOTH_ISSET_ID);
  }
  ...
  public boolean isSetBegin_in_both() {
    return __isset_bit_vector.get(__BEGIN_IN_BOTH_ISSET_ID);
  }

  public void setBegin_in_bothIsSet(boolean value) {
    __isset_bit_vector.set(__BEGIN_IN_BOTH_ISSET_ID, value);
  }
  ...
  public int compareTo(VersioningTestV2 other) {
    ...
    VersioningTestV2 typedOther = (VersioningTestV2)other;

    lastComparison = Boolean.valueOf(isSetBegin_in_both()).compareTo(typedOther.isSetBegin_in_both());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBegin_in_both()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.begin_in_both, typedOther.begin_in_both);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewint()).compareTo(typedOther.isSetNewint());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewint()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newint, typedOther.newint);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewbyte()).compareTo(typedOther.isSetNewbyte());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewbyte()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newbyte, typedOther.newbyte);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewshort()).compareTo(typedOther.isSetNewshort());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewshort()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newshort, typedOther.newshort);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewlong()).compareTo(typedOther.isSetNewlong());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewlong()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newlong, typedOther.newlong);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewdouble()).compareTo(typedOther.isSetNewdouble());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewdouble()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newdouble, typedOther.newdouble);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewstruct()).compareTo(typedOther.isSetNewstruct());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewstruct()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newstruct, typedOther.newstruct);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewlist()).compareTo(typedOther.isSetNewlist());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewlist()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newlist, typedOther.newlist);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewset()).compareTo(typedOther.isSetNewset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewset()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newset, typedOther.newset);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewmap()).compareTo(typedOther.isSetNewmap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewmap()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newmap, typedOther.newmap);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNewstring()).compareTo(typedOther.isSetNewstring());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNewstring()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newstring, typedOther.newstring);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetEnd_in_both()).compareTo(typedOther.isSetEnd_in_both());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnd_in_both()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.end_in_both, typedOther.end_in_both);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
